Sprint 1, Tasca 4, Nivell 2, Exercici 1
...
Notes:
- La resolució de l'exercici es troba a l'espai de test.
- S'inclouen tres tests pel matcher personalitzat: el demanat per l'enunciat, que sempre fallarà (matching "Mordor" amb longitud 8), i dues modificacions d'aquest test que funiconaran.
